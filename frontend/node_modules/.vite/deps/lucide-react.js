...
var require_lucide_react = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Icon = react.forwardRef(({ color, size, strokeWidth, absoluteStrokeWidth, className = "", children, iconNode, ...rest }, ref) => {
	...
	var Infinity = createLucideIcon("infinity", [["path", {
...
//#endregion
export default require_lucide_react();
